...
const { escribir_string_file_log, escribir_end_buflog, escribir_header_buflog, escribir_proc_buflog, escribir_buf_log, escribir_buff_after_read_bb, grabar_array_to_file_log } = require("./escribir_log");
// ─── FUNCIÓN DE LOG ───────────────────────────────────────
/*
buflog("Inicio");
buflog("Paso 1");
...
async function main() {
    ...
    let fq_usuario_a_validar = "CN=" + usuario_a_validar + "," + datos_ini.BASE_DN;
    // ----------------------------------------------
    // valido el usuario 
    // ----------------------------------------------
    const usr_val_config = {
        url: url,
    ...
    // -------------------------------------------
    const res = await buscar_usuario(usuario_a_validar, config, bufferSalidaLog, logPath);
